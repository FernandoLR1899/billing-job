...
@SpringBatchTest // Registers the JobLauncherTestUtils and JobRepositoryTestUtils as Spring beans in the test context
@SpringBootTest
...
class BillingJobApplicationTests {
	...
	// One of the features of JobLauncherTestUtils is that it automatically detects
	// the job under test in the application context if it is unique
	@Autowired
