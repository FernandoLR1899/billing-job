...
//    }
    ...
    public Step step1(JobRepository jobRepository, JdbcTransactionManager transactionManager) {
        // This transaction manager is autoconfigured by Spring Boot
    ...
    public Step step3(JobRepository jobRepository, JdbcTransactionManager transactionManager,
        ...
        ReportingData> billingDataProcessor, ItemWriter<ReportingData> billingDataFileWriter) {
    ...
    // Spring Boot looks for our Job in the application context and runs it by using the JobLauncher,
    // which is autoconfigured and ready for us to use.
    @Bean
    public Job job(JobRepository jobRepository, Step step1, Step step2, Step step3) {
        // Thanks to Spring Boot, a JobRepository was autoconfigured with the datasource configured
        // for our PostgreSQL database. This JobRepository is ready for us to use by autowiring it in our Job bean.
